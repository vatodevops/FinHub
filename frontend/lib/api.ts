...
export const api = {
  ...
  createAccount: (payload: Record<string, unknown>) => fetchJson<Account>('/accounts', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  updateAccount: (id: string, payload: Record<string, unknown>) => fetchJson<Account>(`/accounts/${id}`, {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  ...
  createTransaction: (payload: Record<string, unknown>) => fetchJson<Transaction>('/transactions', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  updateTransaction: (id: string, payload: Record<string, unknown>) => fetchJson<Transaction>(`/transactions/${id}`, {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  ...
  createTransfer: (payload: Record<string, unknown>) => fetchJson<Transaction[]>('/transactions/transfer', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  ...
  createCategory: (payload: Record<string, unknown>) => fetchJson<Category>('/categories', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  updateCategory: (id: string, payload: Record<string, unknown>) => fetchJson<Category>(`/categories/${id}`, {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  ...
  createRecurringSeries: (payload: Record<string, unknown>) => fetchJson<RecurringSeries>('/recurring/series', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  updateRecurringSeries: (id: string, payload: Record<string, unknown>) => fetchJson<RecurringSeries>(`/recurring/series/${id}`, {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  ...
  createBudget: (payload: Record<string, unknown>) => fetchJson<Budget>('/budgets', {
    method: 'POST',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
  updateBudget: (id: string, payload: Record<string, unknown>) => fetchJson<Budget>(`/budgets/${id}`, {
    method: 'PATCH',
    headers: { 'content-type': 'application/json' },
    body: JSON.stringify(payload),
  }),
